![build](https://github.com//yastrebow/testdocker/actions/workflows/maven.yaml/badge.svg)
...
Project for testing monitoring with spring boot actuator, prometheus and grafana. Also application prints "Hello, World!" into console every 5 sec
====
